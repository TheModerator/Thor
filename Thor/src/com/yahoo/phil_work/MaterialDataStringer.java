...
public class MaterialDataStringer extends MaterialData {
    ...
    private static final HashMap<String, MaterialData> altNames;
	private static final boolean newTreeTypes = Bukkit.getBukkitVersion().startsWith("1.7");
    static
    {
        altNames = new HashMap<String, MaterialData>();
        ...
        // logs are commonly called wood, but can't add that as alternative due to above Material name          
    ...
    public MaterialDataStringer (MaterialData md) {
    	super (md.getItemType(), md.getData());
    }
